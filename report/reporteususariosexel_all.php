...
$consulta = "SELECT u.id_usuarios, u.usuario, u.nombre, u.cedula, u.correo, u.registro, r.roles FROM usuarios AS u INNER JOIN roles AS r ON r.id_roles=u.id_roles";
