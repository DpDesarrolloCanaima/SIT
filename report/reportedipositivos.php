...
$resultado = $mysqli->query($sql);
	...
	$pdf = new PDF("L", "mm", array(300,455));
	$pdf->AliasNbPages();
	$pdf->AddPage();
	...
	$pdf->Cell(20, 5,$row['tipo_de_motivo'], 1, 0, "C");
	$pdf->Cell(30, 5,$row['origen'], 1, 0, "C");
	$pdf->Cell(30, 5,$row['estatus'], 1, 0, "C");
	}
