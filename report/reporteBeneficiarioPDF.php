    ...
    switch ($beneficiario) {
        case 1:
            require "plantillaapoyo.php";
                    ...
                    INNER JOIN tipo_documento AS d ON d.id_documento = e.tipo_documento WHERE e.id_origen = '$beneficiario' ";
            ...
            case 2:
                ...
                INNER JOIN origen AS o ON o.id_origen = e.id_origen
                INNER JOIN estados_venezuela AS v ON v.id_estados = e.estado WHERE e.id_origen = '$beneficiario'";
                $resultado = $mysqli->query($sql);
