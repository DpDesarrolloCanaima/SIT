...
function Header()
{
    ...
    $this->Cell(80);
    // Título
    $this->Cell(380,10,'Dispositivos Por Verificar',0,0,'C');
    // Salto de línea
    $this->Ln(20);
}
...
function Footer()
{
 // Posición: a 1,5 cm del final
    ...
    $this->Cell(0,10,utf8_decode("Ubicado en: Base Área Generalisimo Francisco de Miranda (La Carlota) Caracas-Venezuela"),0,1,"C");
