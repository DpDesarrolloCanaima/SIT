<?php
	...
	$id = $_REQUEST['id'];
	$sql = "SELECT d.serial_equipo, d.serial_de_cargador, d.institucion_educativa, d.institucion_donde_estudia, d.fecha_de_recepcion, d.estado_recepcion_equipo, d.fecha_de_entrega,d.comprobaciones, j.nombre, j.modelo, l.grado, k.origen, m.estatus, b.tipo_de_motivo , t.estado FROM datos_del_dispotivo AS d 
...
$resultado = $mysqli->query($sql);
	...
	$pdf = new PDF("L", "mm", array(300,650));
	$pdf->AliasNbPages();
	$pdf->AddPage();
	...
	$pdf->Cell(70, 5,"Observaciones", 1, 0, "C");
	$pdf->Cell(90, 5,"Comprobaciones", 1, 0, "C");
	...
	$pdf->Cell(70, 5,$row['observaciones'], 1, 0, "C");
	$pdf->Cell(90, 5,$row['comprobaciones'], 1, 0, "C");
