                ...
                <form action="verifificartecnico.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <input class="form-check-input i-radio" type="radio" name="pila_bios" id="pila_bios_2"
                                value="si">
                        </div>
                        <div class="form-check">
                            ...
                            <input class="form-check-input " type="radio" name="pila_bios" id="pila_bios_2" value="no">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <input class="form-check-input i-radio" type="radio" name="cara_b" id="pila_bios_2"
                                value="si">
                        </div>
                        <div class="form-check">
                            <label class="form-check-label" for="pila_bios_2">
                            ...
                            <input class="form-check-input " type="radio" name="cara_b" id="pila_bios_2" value="no">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <input class="form-check-input i-radio" type="radio" name="cara_c" id="pila_bios_2"
                                value="si">
                        </div>
                        <div class="form-check">
                            <label class="form-check-label" for="pila_bios_2">
                            ...
                            <input class="form-check-input " type="radio" name="cara_c" id="pila_bios_2" value="no">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <label class="form-check-label" for="cara_d_1">
                                Si
                            </label>
                            <input class="form-check-input i-radio" type="radio" name="cara_d" id="cara_d_1" value="si">
                        </div>
                        <div class="form-check">
                            <label class="form-check-label" for="cara_d_2">
                                No
                            </label>
                            <input class="form-check-input " type="radio" name="cara_d" id="cara_d_2" value="no">
                        </div>
