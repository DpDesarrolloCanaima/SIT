<!-- Modal -->
<div class="modal fade" id="editJornadas<?php echo $row['id_datos_del_entregante'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre_bene" name="nombre_de_institucion_jornada" value="<?php echo $row['nombre_del_beneficiario'];?>">
                        <span></span>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="direccion" rows="3" name="direccion"><?php echo $row['direccion'];?></textarea>
                        <span></span>
                    </div>
                    <div class="form-group">
                        <label for="fechaNacBene">Fecha de Jornada</label>
                        <input type="date" class="form-control" id="fechaJornada" name="fechaJornada" value="<?php echo $row['fecha_de_nacimiento'];?>">
                    </div>
                    <hr>
