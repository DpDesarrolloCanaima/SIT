...
$sqlEquipoLaptop = "SELECT serial_id_l, serial_cara_b FROM equipo_tablet";
...
?>
                            ...
                            <div class="row p-4">
                                                    ...
                                                    <?php 
                                                       ...
                                                       switch ($rowEquipos['equipo']) {
                                                        ...
                                                        case 9:
                                                            ...
                                                            break;
                                                        default:
                                                            echo 'Hoy no se registran tablets';
                                                            break;
                                                       }
                                                    endwhile;
                                                    ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $rowRegistroLaptop['serial_id_l'];?></td>
        ...
        ?>
        <script src="js/register/registrarEquipoTablet.js"></script>
    </body>
</html>
