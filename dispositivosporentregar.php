...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div>
                            <button type="button" class="btn btn-primary btn-sm mt-3" data-toggle="modal" data-target="#generarReporteEstatusPorEntregar"> Generar Reporte
                            </button>
                        </div>    
                    </div>
                    <!-- DataTales Example -->
            ...
            <!-- End of Main Content -->
    <?php require "modal/report/estatus/generarReportePorEntregar.php";?>
