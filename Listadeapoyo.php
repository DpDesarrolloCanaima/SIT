...
$sql1 = "SELECT e.id_datos_del_entregante, e.ic, e.nombre_del_beneficiario, d.tipo_documento, e.cedula, e.nombre_del_representante, e.correo, e.telefono, e.municipio, e.direccion, e.id_origen, v.estado_nombre FROM datos_del_entregante AS e 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="report/reportebeneficiarioapoyo.php?id=1" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" target="_blank"><i class="fas fa-download fa-sm text-white-50"></i> Generar Reporte</a>
                        <?php
                                    switch ($rol) {
                                        case 1:
                                            echo '
