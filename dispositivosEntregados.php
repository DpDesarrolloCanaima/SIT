...
$sqlEntregados = "SELECT d.serial_equipo, d.serial_de_cargador, d.fecha_de_recepcion, d.fecha_de_entrega , j.nombre, j.modelo, k.origen , e.id_datos_del_entregantes, e.cedula FROM datos_del_dispotivo AS d 
