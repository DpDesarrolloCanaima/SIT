...
$sql = "SELECT d.id_datos_del_dispositivo, d.serial_equipo, d.serial_de_cargador, d.fecha_de_recepcion, d.estado_recepcion_equipo, d.observaciones_tecnico,j.nombre, j.modelo, k.origen, m.id_estatus, m.estatus, b.tipo_de_motivo , t.estado FROM datos_del_dispotivo AS d 
