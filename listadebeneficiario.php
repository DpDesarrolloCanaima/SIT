            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="report/reportebeneficiario_exel.php?id=2" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" target="_blank"><i class="fas fa-print fa-sm text-white-50"></i> Generar Reporte (EXEL)</a>
                        </div>
                        <?php
                                    switch ($rol) {
                                        case 1:
                                            ...
                                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"
                                                data-toggle="modal" data-target="#modalBene"> <i class="fas fa-user fa-sm text-white-50"></i> Registrar Beneficiario</a>
                                    ...
                                    echo '  <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item btn btn-danger" href="php/eliminar/eliminarbeneficiario.php?id='.$row['id_datos_del_entregante'].'&origen=2"><img src="img/svg/eliminar.svg " alt="Industrias Canaima" width="15" height="15"> Eliminar</a>
