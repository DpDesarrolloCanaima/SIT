...
if ($_POST) {
    ...
    switch ($formato) {
        case 1:
                header("Location: report/reporteEstatusPruebaPDF.php?fd=$primeraFecha&fh=$segundaFecha&est=$estatus&r=$rol");
            break;
        case 2:
            header("Location: report/reporteEstatusPruebaEXCEL.php?fd=$primeraFecha&fh=$segundaFecha&est=$estatus&r=$rol");
            break;
        default:
        echo "
                <script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>
