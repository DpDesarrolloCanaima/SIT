        ...
        <?php
            ...
            switch ($rol) {
                case 3:
                    ...
                    $notiText = "Entregar, ";  
                    $consultaver = "SELECT ic_dispositivo, id_dispositivo, id_tipo_de_dispositivo, registro, observaciones_verificador,  responsable FROM datos_del_dispotivo WHERE id_estatus = ".$estatusDispo." ORDER BY registro DESC ";
                ...
                case 4:
                    ...
                    $notiText = "Reparar, ";
                    $consultaver = "SELECT ic_dispositivo, id_dispositivo, id_tipo_de_dispositivo, registro, observaciones_analista, responsable FROM datos_del_dispotivo WHERE id_estatus = ".$estatusDispo." AND responsable = ".$id_usuarios." ORDER BY
                    registro DESC ";
                    $resultadover = $mysqli->query($consultaver);
                    $numr = $resultadover->num_rows;
                    echo '
                ...
                case 5:
                    ...
                    $notiText = "Verificar, ";
                    $consultaver = "SELECT registro, observaciones_tecnico, id_dispositivo, ic_dispositivo, id_tipo_de_dispositivo FROM
