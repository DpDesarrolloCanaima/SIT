...
?>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Aduana | Registro de Memoria Ram</li>
                        </ol>
                        <div class="container my-4">
                            <div class="row p-4">
                                <div class="col-md-5">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="" id="RegistroMemoria">
                                                <div class="form-group">
                                                    <label for="">Serial de Memoria Ram</label>
                                                    <input type="text" name="serialMemoria" id="serialMemoria" class="form-control">
                                                    <input type="hidden" name="fechaRegistro" id="fechaRegistro" value="<?php echo $fecha;?>">
                                                </div>
                                                <div class="my-3">
                                                    <input type="button" class="btn btn-success" onclick="RegistrarMemoria()" value="Enviar">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $rowRegistroDisco['serial_m_r'];?></td>
        ...
        ?>
        <script src="js/register/registrarMemoria.js"></script>
    </body>
</html>
